...
def modified_boost_optimizer(bid_dict, boost_values, learning_rate):
    """
    DOCUMENTATION
    """
    boost_bid_dict = {}
    ...
    for i in boost_values and bid_dict:
        if i is not high_bidder:
            ...
            # boost_diff = boost_values[i] - max_boost
            # new_boost = boost_values[i] - learning_rate * boost_diff
            boost_values[i] = learning_rate * boost_bid_dict[high_bidder] / bid_dict[i]
        else:
            # min_boost = boost_bid_dict[second_high_bidder] / bid_dict[i]
            # boost_diff = boost_values[i] - min_boost
            # new_boost = boost_values[i] - learning_rate * boost_diff
            boost_values[i] = learning_rate * boost_bid_dict[second_high_bidder] / bid_dict[i]
